...
Discord.Lang = {
    ...
    ONLINE_MESSAGE_TITLE = 'Сервер уже онлайн!',
    ONLINE_MESSAGE_DESCRIPTION = 'Присоединяйся!: <join_url>!',
    ...
    PLAYER_JOIN = 'Игрок <name> (<steam_id>) присоединяется к серверу',
    PLAYER_DISCONNECT = 'Игрок <name> (<steam_id>) вышел. Причина:(<reason>)',
